...
import com.example.uts2.databinding.ActivitySigninBinding
        ...
        binding.button.setOnClickListener{ //agar saat tombol ditekan akan merespon
            ...
            if (email.isNotEmpty() && pass.isNotEmpty()) {
                    ...
                    firebaseAuth.signInWithEmailAndPassword(email, pass).addOnCompleteListener {
                        if (it.isSuccessful) {
                            val intent = Intent(this, coba::class.java) //jika login berhasil, akan langsung diarahkan ke menu chat
                            startActivity(intent)
